...
public final class HttpResponseEvent {
    ...
    HttpResponseEvent(HttpRequest request, HttpResponse response, HttpException te) {
        this.request = request;
        this.response = response;
        this.httpException = te;
    }
    ...
    /**
     * returns the HttpException associated with the event
     *
     * @return the HttpException associated with the event
     */
